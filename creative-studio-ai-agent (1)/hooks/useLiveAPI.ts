...
export const useLiveAPI = ({ apiKey, onDisconnect }: UseLiveAPIProps) => {
  ...
  const disconnect = useCallback(() => {
    ...
    // The SDK doesn't expose a clean .close() on the promise wrapper easily without holding the session object
    // But cleaning up the input stream effectively stops the conversation from the client side.
